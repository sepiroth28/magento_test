...
class Shopshopnshop_Tntshipping_Block_Adminhtml_Tntshippingdescription_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_updateButton('save', 'label', Mage::helper('tntshipping')->__('Save'));
    ...
    public function getHeaderText()
    {
        if( Mage::registry('tntshipping_data') && Mage::registry('tntshipping_data')->getId() ) {
            ...
            return Mage::helper('tntshipping')->__('Add Tnt type');
        }
    }
}
