...
class Shopshopnshop_Tntshipping_Block_Adminhtml_Tntshipping_Edit_Tab_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  {
      return $this->getUrl('*/adminhtml_tntdescription/edit', array('id' => $row->getId()));
  }
