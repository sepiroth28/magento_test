 ...
 */
class Shopshopnshops_Productpromo_Block_Adminhtml_Productpromo_Tree extends Mage_Adminhtml_Block_Catalog_Category_Abstract
{
    ...
    {
        parent::__construct();
        $this->setTemplate('productpromo/tree.phtml');
