...
class Shopshopnshops_Promoheader_Block_Adminhtml_Layoutmanager_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
  protected function _prepareForm()
  {
      $form = new Varien_Data_Form();
	  $promoheader = Mage::getModel('promoheader/layoutmanager')->getCollection()->getData();
	  $layout_edit_id = $this->getRequest()->getParam('id');
	  
	  $url = Mage::helper("adminhtml")->getUrl("promoheader/adminhtml_layoutmanager/renderblock/",array("param1"=>1,"param2"=>2));
