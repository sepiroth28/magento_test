...
class Shopshopnshops_Promoheader_Block_Adminhtml_Promoheader_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
  protected function _prepareForm()
  {
	  ...
	  $edit_url = Mage::helper("adminhtml")->getUrl("promoheader/adminhtml_promoheader/editblock/",array("edit_id"=>$layout_edit_id));
	  
	  $promoheader = Mage::getModel('promoheader/promoheader')->getCollection($layout_edit_id)->getData();
