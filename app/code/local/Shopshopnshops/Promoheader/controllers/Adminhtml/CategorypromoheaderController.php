...
class Shopshopnshops_Promoheader_Adminhtml_CategorypromoheaderController extends Mage_Adminhtml_Controller_Action
{
	
	protected function _initAction() {
		$this->loadLayout()
			->_setActiveMenu('categorypromoheader/items')
			->_addBreadcrumb(Mage::helper('adminhtml')->__('Category Promoheader Item'), Mage::helper('adminhtml')->__('Category Promoheader Item'));
	...
	public function editAction() {
		...
		if ($model->getId() || $id == 0) {
			...
			$this->loadLayout();
			$this->_setActiveMenu('categorypromoheader/items');
			...
			$this->_addContent($this->getLayout()->createBlock('promoheader/adminhtml_categorypromoheader_edit'))
				->_addLeft($this->getLayout()->createBlock('promoheader/adminhtml_categorypromoheader_edit_tabs'));
...
*/###################################################################################
			...
			$data['layout_position_css_category'] = implode(';',$block_position);
...
*/###################################################################################				
			...
			$model = Mage::getModel('promoheader/categorypromoheader');
...
/*##########################################################################################################	*/			
				/*$sql = "UPDATE category_promoheader SET `default` = 0";
        ...
        if(!is_array($promoheaderIds)) {
            ...
            try {
                foreach ($promoheaderIds as $promoheaderId) {
                    $promoheader = Mage::getModel('promoheader/categorypromoheader')->load($promoheaderId);
                    $promoheader->delete();
                }
    ...
    public function massStatusAction()
    {
        ...
        if(!is_array($promoheaderIds)) {
            ...
            try {
                foreach ($promoheaderIds as $promoheaderId) {
                    $promoheader = Mage::getSingleton('promoheader/categorypromoheader')
                        ->load($promoheaderId)
    ...
    public function exportCsvAction()
    {
        ...
        $content    = $this->getLayout()->createBlock('promoheader/adminhtml_categorypromoheader_grid')
            ->getCsv();
